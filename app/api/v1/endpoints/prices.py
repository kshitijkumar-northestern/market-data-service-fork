...
async def get_latest_price(
    ...
    try:
        # Fixed: Handle Optional[str] provider properly
        provider_name = provider if provider is not None else "yfinance"
        price_data = await market_service.get_latest_price(symbol, provider_name)
...
# Fixed: Removed duplicate code below this line
